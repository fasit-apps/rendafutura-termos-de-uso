# Termos de Uso – RendaFutura

Ao acessar ou utilizar o aplicativo **RendaFutura**, o usuário declara que leu, compreendeu e concorda integralmente com os presentes **Termos de Uso**.
...
## 2. Simulações e Resultados Apresentados
...
## 5. Atualizações e Modificações dos Termos

Estes Termos de Uso podem ser **alterados, atualizados ou revisados a qualquer momento**, visando adequação legal, técnica ou operacional.

A versão mais recente estará sempre disponível no aplicativo.

Recomenda-se que o usuário **revise periodicamente** este documento.

O uso contínuo do aplicativo após alterações implica **aceitação automática** dos novos termos.
